...
import 'package:bobshare/pages/edit_profile.dart';
import 'package:bobshare/widgets/header.dart';
import 'package:bobshare/widgets/post.dart';
import 'package:bobshare/widgets/post_tile.dart';
...
class _ProfileState extends State<Profile> {
  ...
  Widget buildButton({IconData icon, Function function}) {
    return CircleAvatar(
      child: IconButton(
          icon: Icon(
            icon,
                ...
                children: <Widget>[
                  Stack(
                    children: <Widget>[
                      ...
                      Positioned(
                          bottom: 8, right: 0, child: buildProfileButton()),
                    ],
                  ),
                  Padding(
