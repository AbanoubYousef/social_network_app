...
import 'package:bobshare/pages/comments.dart';
...
class _PostState extends State<Post> {
  ...
  handleLikePost() {
    bool _isLiked = likes[currentUser.userId] == true;
...
//      height: 300,
      child: GestureDetector(
        ...
        child: Stack(
          ...
          children: <Widget>[
            cachedNetworkImage(mediaUrl: mediaUrl,width: MediaQuery.of(context).size.width*.95),
            showHeart
                ? Animator(
